...
- **Ubuntu Software Center** in {{< figure src="menu_16.png" >}} Applications menu **»** {{< figure src="softwarecenter_synaptic_16.png" >}} Ubuntu Software Center
- **Synaptic Package Manager** in {{< figure src="menu_16.png" >}} Applications menu **»** {{< figure src="system_16.png" >}} System **»** {{< figure src="softwarecenter_synaptic_16.png" >}} Synaptic Package Manager
- **apt-get**
...
If the window decorations and/or panels don’t start automatically on login, add the respective commands to your session from  {{< figure src="menu_16.png" >}} Applications menu Applications Menu **»** Settings » Settings Manager in Session and Startup on the Application Autostart tab.
