...
We want to send thanks to all of our contributors, especially those who helped make the Beta 2 testing cover much more ground than Beta 1. Keep up the good work! The development status along with a full list of work tasks done by the team and other contributors, including many tasks not directly visible to our end-users, can be found at <http://status.ubuntu.com/ubuntu-s/group/topic-s-flavor-xubuntu.html>. To find out more about how to contribute to Xubuntu and join in, see the [Get Involved](/contribute/ "Get Involved") section.
