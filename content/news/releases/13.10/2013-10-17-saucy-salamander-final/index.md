...
We want to thank all of our contributors: keep up the good work! The development status along with a full list of work tasks done by the team and other contributors, including many tasks not directly visible to our end-users, can be found at <http://status.ubuntu.com/ubuntu-s/group/topic-s-flavor-xubuntu.html>. To find out more about how to contribute to Xubuntu and join in as we get ready to develop a new long-term support (LTS) release, see the [Get Involved](/contribute/ "Get Involved") section.
