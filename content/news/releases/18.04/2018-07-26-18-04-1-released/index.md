...
The **point release images** are available as torrents and direct downloads immediately from [xubuntu.org/getxubuntu/](/getxubuntu). As the main server and mirrors might be busy for the first few days after the release, we recommend using the torrents if possible.
