...
You can easily upgrade over the network with the following procedure. Upgrades from Xubuntu 25.04 are supported. For all other Ubuntu systems, please read [QuestingUpgrades](https://help.ubuntu.com/community/QuestingUpgrades) on ubuntu.com.
